...
class GAN(object):
    ...
    def build_model(self):
        ...
        self.inputs = tf.placeholder(
            tf.float32, [bs] + image_dims, name='real_images')
    ...
    def train(self):
        ...
        self.sample_z = np.random.uniform(
            -1, 1, size=(self.batch_size, self.z_dim))
